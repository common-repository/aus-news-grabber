...
* Otherwise open the site and right click on web page to select View page source. In the source code look for anything that has terms like 'feed', '.xml', or 'rss'.
